...
const (
	badDataFormat = "ошибочный формат пакета"//"ошибочный формат пакета"
	badDataDay    = "неверный день"//"неверный день"
	badDataTime   = "некорректное значение времени"//"некорректное значение времени"
)
